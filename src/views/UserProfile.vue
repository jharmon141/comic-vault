        ...
        <v-container>
            <v-layout>
                <v-flex md8 offset-md2>
                    ...
                    <v-icon v-if="!$store.state.user.profilePic">person</v-icon>
                    <img v-else :src="$store.state.user.profilePic" class="userProfilePic">
                        ...
                        <v-card>
                            ...
                            <v-card-text>
                                <v-form ref="profilePicLink" lazy-validation>
                                    <v-text-field label="Image URL" v-model="profilePicURL" @keyup.enter="updateProfilePic">
                                    </v-text-field>
                                </v-form>
                            </v-card-text>
                    ...
                    <v-form ref="updateUserForm" lazy-validation>
                        <v-text-field label="First Name" v-model="updateFirstName" @keyup.enter="updateUser">
                        </v-text-field>
                        <v-text-field label="Last Name" v-model="updateLastName" @keyup.enter="updateUser">
                        </v-text-field>
                        <v-text-field label="Username" v-model="updateUsername" @keyup.enter="updateUser">
                        </v-text-field>
...
import {
    ...
    UPDATE_USER_PROFILE_PIC_MUTATION
